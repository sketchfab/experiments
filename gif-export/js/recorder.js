(function(window) {
    ...
    window['setRecordingTarget'] = setRecordingTarget;
    window['enableTransmitToIframe'] = enableTransmitToIframe;
    window['disableTransmitToIframe'] = disableTransmitToIframe;
