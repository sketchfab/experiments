(function(window, Sketchfab, GIF) {
    ...
    SketchfabGif.prototype.capture = function(api, nb, callback) {
        ...
        function _capture(i) {
            ...
            api.getCameraLookAt(function(err, camera) {
                ...
                var newCamera = window.SketchfabGifAnimations.annotations( camera, nb - i, nb);
    ...
    window.SketchfabGif = SketchfabGif;

})(window, Sketchfab, GIF);
